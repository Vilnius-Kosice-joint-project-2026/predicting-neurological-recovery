...
```powershell
python analysis/official_scoring_metric/evaluate_model.py analysis/official_scoring_metric/demo_data/labels_generated analysis/official_scoring_metric/demo_data/outputs_generated
```